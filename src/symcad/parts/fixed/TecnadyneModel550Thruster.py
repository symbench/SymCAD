...
class TecnadyneModel550Thruster(FixedPart):
   """Model representing a Tecnadyne Model 550 thruster.

   By default, the part is oriented in the following way:

   ![TecnadyneModel550Thruster](https://symbench.github.io/SymCAD/images/TecnadyneModel550Thruster.png)
   """

   # Constructor ----------------------------------------------------------------------------------

   def __init__(self, identifier: str) -> None:
      """Initializes the Tecnadyne Model 550 thruster fixed-geometry part.
      ...
      """
      super().__init__(identifier, 'thrusters/Tecnadyne_Model_550.FCStd', 3097.128)
