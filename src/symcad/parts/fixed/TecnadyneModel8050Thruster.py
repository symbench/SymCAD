...
class TecnadyneModel8050Thruster(FixedPart):
   """Model representing a Tecnadyne Model 8050 thruster.

   By default, the part is oriented in the following way:

   ![TecnadyneModel8050Thruster](https://symbench.github.io/SymCAD/images/TecnadyneModel8050Thruster.png)
   """

   # Constructor ----------------------------------------------------------------------------------

   def __init__(self, identifier: str) -> None:
      """Initializes the Tecnadyne Model 8050 thruster fixed-geometry part.
      ...
      """
      super().__init__(identifier, 'thrusters/Tecnadyne_Model_8050.FCStd', 3170.0)
