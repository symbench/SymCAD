...
class iXbluePhinsCompactC7Ins(FixedPart):
   """Model representing an iXblue Phins Compact C7 INS sensor.

   By default, the part is oriented in the following way:

   ![iXbluePhinsCompactC7Ins](https://symbench.github.io/SymCAD/images/iXbluePhinsCompactC7Ins.png)
   """
   ...
   def __init__(self, identifier: str) -> None:
      ...
      """
      super().__init__(identifier, 'sensors/iXblue-Phins-Compact-C7-INS.FCStd', 751.2818)
      self.set_unexposed()
