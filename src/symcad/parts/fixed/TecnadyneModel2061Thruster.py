...
class TecnadyneModel2061Thruster(FixedPart):
   """Model representing a Tecnadyne Model 2061 thruster.

   By default, the part is oriented in the following way:

   ![TecnadyneModel2061Thruster](https://symbench.github.io/SymCAD/images/TecnadyneModel2061Thruster.png)
   """

   # Constructor ----------------------------------------------------------------------------------

   def __init__(self, identifier: str) -> None:
      """Initializes the Tecnadyne Model 2061 thruster fixed-geometry part.
      ...
      """
      super().__init__(identifier, 'thrusters/Tecnadyne_Model_2061.FCStd', 3331.1)
