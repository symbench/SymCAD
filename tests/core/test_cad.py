...
from symcad.parts import Custom, FlangedFlatPlate, Pipe
...
def run_cad_tests(delete_cad_models: bool):
   ...
   # Test built-in modeled construction (using FlangedFlatPlate as a proxy)
   plate = FlangedFlatPlate('TestPlate', 1000.0)
   assert plate.__cad__ is not None
   assert isinstance(plate.__cad__, ModeledCad)
   assert os.path.exists(plate.__cad__.cad_file_path)
   ...
   concrete_params = {'radius': 0.22, 'flange_radius': 0.08, 'height': 0.6, 'thickness': 0.0025}
   props = plate.__cad__.get_physical_properties(concrete_params, (0.0, 0.0, 0.0), 1000.0)
   ...
   plate.__cad__.export_model('test_out_plate_builtin.FCStd', 'freecad', concrete_params, (0.0, 0.0, 0.0))
   plate.__cad__.export_model('test_out_plate_builtin.stl', 'stl', concrete_params, (0.0, 0.0, 0.0))
   plate.__cad__.export_model('test_out_plate_builtin.stp', 'step', concrete_params, (0.0, 0.0, 0.0))
   if delete_cad_models:
      os.remove('test_out_plate_builtin.FCStd')
      os.remove('test_out_plate_builtin.stl')
      os.remove('test_out_plate_builtin.stp')

   # Test physical property retrieval from a built-in scripted construction
   props = pipe.__cad__.get_physical_properties(concrete_params, (0.0, 0.0, 0.0), 1000.0)
   assert 'xlen' in props and 'ylen' in props and 'zlen' in props
   assert 'cg_x' in props and 'cg_y' in props and 'cg_z' in props
   assert 'cb_x' in props and 'cb_y' in props and 'cb_z' in props
   assert 'mass' in props
   ...
   pipe.__cad__.export_model('test_out_pipe_builtin.FCStd', 'freecad', concrete_params, (0.0, 0.0, 0.0))
   pipe.__cad__.export_model('test_out_pipe_builtin.stl', 'stl', concrete_params, (0.0, 0.0, 0.0))
   pipe.__cad__.export_model('test_out_pipe_builtin.stp', 'step', concrete_params, (0.0, 0.0, 0.0))
   if delete_cad_models:
   ...
   props = external_plate.__cad__.get_physical_properties(concrete_params, (0.0, 0.0, 0.0), 1000.0)
   assert 'xlen' in props and 'ylen' in props and 'zlen' in props
   assert 'cg_x' in props and 'cg_y' in props and 'cg_z' in props
   assert 'cb_x' in props and 'cb_y' in props and 'cb_z' in props
   assert 'mass' in props
   ...
   external_plate.__cad__.export_model('test_out_plate_external.FCStd', 'freecad', concrete_params, (0.0, 0.0, 0.0))
   external_plate.__cad__.export_model('test_out_plate_external.stl', 'stl', concrete_params, (0.0, 0.0, 0.0))
   external_plate.__cad__.export_model('test_out_plate_external.stp', 'step', concrete_params, (0.0, 0.0, 0.0))
   if delete_cad_models:
   ...
   props = external_plate_converted.__cad__.get_physical_properties(concrete_params, (0.0, 0.0, 0.0), 1000.0)
   assert 'xlen' in props and 'ylen' in props and 'zlen' in props
   assert 'cg_x' in props and 'cg_y' in props and 'cg_z' in props
   assert 'cb_x' in props and 'cb_y' in props and 'cb_z' in props
   assert 'mass' in props
   ...
   external_plate_converted.__cad__.\
      export_model('test_out_plate_external_converted.FCStd', 'freecad', concrete_params, (0.0, 0.0, 0.0))
   external_plate_converted.__cad__.\
      export_model('test_out_plate_external_converted.stl', 'stl', concrete_params, (0.0, 0.0, 0.0))
   external_plate_converted.__cad__.\
      export_model('test_out_plate_external_converted.stp', 'step', concrete_params, (0.0, 0.0, 0.0))
   if delete_cad_models:
   ...
   props = external_pipe.__cad__.get_physical_properties(concrete_params, (0.0, 0.0, 0.0), 1000.0)
   assert 'xlen' in props and 'ylen' in props and 'zlen' in props
   assert 'cg_x' in props and 'cg_y' in props and 'cg_z' in props
   assert 'cb_x' in props and 'cb_y' in props and 'cb_z' in props
   assert 'mass' in props
   ...
   external_pipe.__cad__.export_model('test_out_pipe_external.FCStd', 'freecad', concrete_params, (0.0, 0.0, 0.0))
   external_pipe.__cad__.export_model('test_out_pipe_external.stl', 'stl', concrete_params, (0.0, 0.0, 0.0))
   external_pipe.__cad__.export_model('test_out_pipe_external.stp', 'step', concrete_params, (0.0, 0.0, 0.0))
   if delete_cad_models:
   ...
   front_endcap_placement_point = Coordinate('front_endcap_placement_point', x=0.0, y=0.0, z=0.0)
   front_endcap_orientation = (180.0, 0.0, 0.0)
   front_endcap_placement = (0.0, 0.0, 0.0)
   center_pipe_placement_point = Coordinate('center_pipe_placement_point', x=0.0, y=0.0, z=0.0)
   center_pipe_orientation = (0.0, -90.0, 0.0)
   center_pipe_placement = (concrete_params['height'], 0.0, 0.0)
   rear_endcap_placement_point = Coordinate('rear_endcap_placement_point', x=0.0, y=0.0, z=0.0)
   rear_endcap_orientation = (0.0, 0.0, 0.0)
   rear_endcap_placement = (concrete_params['height'], 0.0, 0.0)
   plate.__cad__.add_to_assembly('FrontEndcap', doc, concrete_params,
      front_endcap_placement_point, front_endcap_placement, front_endcap_orientation)
   plate.__cad__.add_to_assembly('RearEndcap', doc, concrete_params,
