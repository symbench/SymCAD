...
def test_oriented_properties(print_output: bool = False):
   ...
   shape_concrete = Cone(concrete_identifier, 2.0)\
      .set_geometry(bottom_radius_m=3.0, top_radius_m=1.0, height_m=3.0)\
   ...
   assert abs(shape_concrete.oriented_width - props['ylen']) < 0.05
