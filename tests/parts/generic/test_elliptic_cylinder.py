...
from symcad.parts import EllipticCylinder, SymPart

symbolic_identifier = 'elliptic_cylinder_symbolic'
hybrid_identifier = 'elliptic_cylinder_hybrid'
concrete_identifier = 'elliptic_cylinder_concrete'

def test_construction(print_output: bool = False):

   # Construct a default instance of the shape
   shape_symbolic = EllipticCylinder(symbolic_identifier)

   # Assert that the shape type is as expected
   assert issubclass(EllipticCylinder, SymPart)
   assert isinstance(shape_symbolic, SymPart)
   assert isinstance(shape_symbolic, EllipticCylinder)
...
def test_setting(print_output: bool = False):
   ...
   shape_symbolic = EllipticCylinder(symbolic_identifier)
   shape_hybrid = EllipticCylinder(hybrid_identifier).set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=None)
   shape_concrete = EllipticCylinder(concrete_identifier).set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=3.0)\
   ...
   shape_concrete.set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=3.0)
...
def test_geometric_properties(print_output: bool = False):
   ...
   shape_symbolic = EllipticCylinder(symbolic_identifier)
   shape_hybrid = EllipticCylinder(hybrid_identifier).set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=None)
   shape_concrete = EllipticCylinder(concrete_identifier, 2.0).set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=3.0)
...
def test_oriented_properties(print_output: bool = False):
   ...
   shape_concrete = EllipticCylinder(concrete_identifier, 2.0)\
      .set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=3.0)\
...
def test_cad(_print_output: bool = False):
   ...
   shape_concrete = EllipticCylinder(concrete_identifier).set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=3.0)
   shape_concrete_rolled = EllipticCylinder(concrete_identifier).set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=3.0)\
                                                                .set_orientation(roll_deg=20.0, pitch_deg=0.0, yaw_deg=0.0)
   shape_concrete_pitched = EllipticCylinder(concrete_identifier).set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=3.0)\
                                                                 .set_orientation(roll_deg=0.0, pitch_deg=20.0, yaw_deg=0.0)
   shape_concrete_yawed = EllipticCylinder(concrete_identifier).set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=3.0)\
                                                               .set_orientation(roll_deg=0.0, pitch_deg=0.0, yaw_deg=20.0)
   shape_concrete_rotated = EllipticCylinder(concrete_identifier).set_geometry(major_radius_m=1.5, minor_radius_m=0.5, height_m=3.0)\
                                                                 .set_orientation(roll_deg=-20.0, pitch_deg=-20.0, yaw_deg=-20.0)

   # Export FreeCAD versions of the rotated shapes
   shape_concrete.export('elliptic_cylinder.FCStd', 'freecad')
   shape_concrete_rolled.export('elliptic_cylinder_rolled.FCStd', 'freecad')
   shape_concrete_pitched.export('elliptic_cylinder_pitched.FCStd', 'freecad')
   shape_concrete_yawed.export('elliptic_cylinder_yawed.FCStd', 'freecad')
   shape_concrete_rotated.export('elliptic_cylinder_rotated.FCStd', 'freecad')
   os.remove('elliptic_cylinder.FCStd')
   os.remove('elliptic_cylinder_rolled.FCStd')
   os.remove('elliptic_cylinder_pitched.FCStd')
   os.remove('elliptic_cylinder_yawed.FCStd')
   os.remove('elliptic_cylinder_rotated.FCStd')
