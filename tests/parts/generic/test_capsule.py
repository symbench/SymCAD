...
def test_geometric_properties(print_output: bool = False):
   ...
   assert abs(cad_props['surface_area'] - shape_concrete.surface_area) < 0.05
...
def test_oriented_properties(print_output: bool = False):
   ...
   shape_concrete = Capsule(concrete_identifier, 2.0)\
      .set_geometry(cylinder_radius_m=1.0, cylinder_length_m=2.0, endcap_length_m=0.5, thickness_m=0.01)\
