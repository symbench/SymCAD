...
from symcad.parts import CrossFormAirfoils, SymPart
...
def test_construction(print_output: bool = False):
   ...
   shape_symbolic = CrossFormAirfoils(symbolic_identifier)

   # Assert that the shape type is as expected
   assert issubclass(CrossFormAirfoils, SymPart)
   assert isinstance(shape_symbolic, SymPart)
   assert isinstance(shape_symbolic, CrossFormAirfoils)
...
def test_setting(print_output: bool = False):
   ...
   shape_symbolic = CrossFormAirfoils(symbolic_identifier)
   shape_hybrid = CrossFormAirfoils(hybrid_identifier).set_geometry(max_thickness_percent=0.12, chord_length_m=0.16, span_m=None, separation_radius_m=0.3, curvature_tilt_deg=30.0)
   shape_concrete = CrossFormAirfoils(concrete_identifier).set_geometry(max_thickness_percent=0.12, chord_length_m=0.16, span_m=0.2, separation_radius_m=0.3, curvature_tilt_deg=30.0)\
...
def test_cad(_print_output: bool = False):
   ...
   shape_concrete = CrossFormAirfoils(concrete_identifier).set_geometry(max_thickness_percent=0.12, chord_length_m=0.16, span_m=0.2, separation_radius_m=0.3, curvature_tilt_deg=30.0)
   shape_concrete_rolled = CrossFormAirfoils(concrete_identifier).set_geometry(max_thickness_percent=0.12, chord_length_m=0.16, span_m=0.2, separation_radius_m=0.3, curvature_tilt_deg=30.0)\
                                                                 .set_orientation(roll_deg=20.0, pitch_deg=0.0, yaw_deg=0.0)
   shape_concrete_pitched = CrossFormAirfoils(concrete_identifier).set_geometry(max_thickness_percent=0.12, chord_length_m=0.16, span_m=0.2, separation_radius_m=0.3, curvature_tilt_deg=30.0)\
                                                                  .set_orientation(roll_deg=0.0, pitch_deg=20.0, yaw_deg=0.0)
   shape_concrete_yawed = CrossFormAirfoils(concrete_identifier).set_geometry(max_thickness_percent=0.12, chord_length_m=0.16, span_m=0.2, separation_radius_m=0.3, curvature_tilt_deg=30.0)\
                                                                .set_orientation(roll_deg=0.0, pitch_deg=0.0, yaw_deg=20.0)
   shape_concrete_rotated = CrossFormAirfoils(concrete_identifier).set_geometry(max_thickness_percent=0.12, chord_length_m=0.16, span_m=0.2, separation_radius_m=0.3, curvature_tilt_deg=30.0)\
