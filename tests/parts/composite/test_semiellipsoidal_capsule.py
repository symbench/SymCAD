...
from symcad.parts import SemiellipsoidalCapsule, SymPart
...
def test_construction(print_output: bool = False):
   ...
   shape_symbolic = SemiellipsoidalCapsule(symbolic_identifier)

   # Assert that the shape type is as expected
   assert issubclass(SemiellipsoidalCapsule, SymPart)
   assert isinstance(shape_symbolic, SymPart)
   assert isinstance(shape_symbolic, SemiellipsoidalCapsule)
   ...
   assert shape_symbolic.geometry.endcap_radius == 0.5 * sympy.Symbol(symbolic_identifier + '_cylinder_radius')
...
def test_setting(print_output: bool = False):
   ...
   shape_symbolic = SemiellipsoidalCapsule(symbolic_identifier)
   shape_hybrid = SemiellipsoidalCapsule(hybrid_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=None, cylinder_thickness_m=None, endcap_radius_m=0.05, endcap_thickness_m=0.005)
   shape_concrete = SemiellipsoidalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_radius_m=0.05, endcap_thickness_m=0.005)\
   ...
   assert shape_hybrid.geometry.endcap_radius == 0.05
   ...
   assert shape_concrete.geometry.endcap_radius == 0.05
...
def test_cad(_print_output: bool = False):
   ...
   shape_concrete = SemiellipsoidalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_radius_m=0.05, endcap_thickness_m=0.005)
   shape_concrete_rolled = SemiellipsoidalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_radius_m=0.05, endcap_thickness_m=0.005)\
                                                                      .set_orientation(roll_deg=20.0, pitch_deg=0.0, yaw_deg=0.0)
   shape_concrete_pitched = SemiellipsoidalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_radius_m=0.05, endcap_thickness_m=0.005)\
                                                                       .set_orientation(roll_deg=0.0, pitch_deg=20.0, yaw_deg=0.0)
   shape_concrete_yawed = SemiellipsoidalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_radius_m=0.05, endcap_thickness_m=0.005)\
                                                                     .set_orientation(roll_deg=0.0, pitch_deg=0.0, yaw_deg=20.0)
   shape_concrete_rotated = SemiellipsoidalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_radius_m=0.05, endcap_thickness_m=0.005)\
