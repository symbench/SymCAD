...
from symcad.parts import FlangedFlatCapsule, SymPart
...
def test_construction(print_output: bool = False):
   ...
   shape_symbolic = FlangedFlatCapsule(symbolic_identifier)

   # Assert that the shape type is as expected
   assert issubclass(FlangedFlatCapsule, SymPart)
   assert isinstance(shape_symbolic, SymPart)
   assert isinstance(shape_symbolic, FlangedFlatCapsule)
...
def test_setting(print_output: bool = False):
   ...
   shape_symbolic = FlangedFlatCapsule(symbolic_identifier)
   shape_hybrid = FlangedFlatCapsule(hybrid_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=None, cylinder_thickness_m=None, endcap_thickness_m=0.02)
   shape_concrete = FlangedFlatCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.02)\
   ...
   assert shape_hybrid.geometry.endcap_thickness == 0.02
   ...
   assert shape_concrete.geometry.endcap_thickness == 0.02
...
def test_cad(_print_output: bool = False):
   ...
   shape_concrete = FlangedFlatCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.02)
   shape_concrete_rolled = FlangedFlatCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.02)\
                                                                  .set_orientation(roll_deg=20.0, pitch_deg=0.0, yaw_deg=0.0)
   shape_concrete_pitched = FlangedFlatCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.02)\
                                                                   .set_orientation(roll_deg=0.0, pitch_deg=20.0, yaw_deg=0.0)
   shape_concrete_yawed = FlangedFlatCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.02)\
                                                                 .set_orientation(roll_deg=0.0, pitch_deg=0.0, yaw_deg=20.0)
   shape_concrete_rotated = FlangedFlatCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.02)\
