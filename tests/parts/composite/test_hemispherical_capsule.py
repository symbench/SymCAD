...
from symcad.parts import HemisphericalCapsule, SymPart
...
def test_construction(print_output: bool = False):
   ...
   shape_symbolic = HemisphericalCapsule(symbolic_identifier)

   # Assert that the shape type is as expected
   assert issubclass(HemisphericalCapsule, SymPart)
   assert isinstance(shape_symbolic, SymPart)
   assert isinstance(shape_symbolic, HemisphericalCapsule)
...
def test_setting(print_output: bool = False):
   ...
   shape_symbolic = HemisphericalCapsule(symbolic_identifier)
   shape_hybrid = HemisphericalCapsule(hybrid_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=None, cylinder_thickness_m=None, endcap_thickness_m=0.005)
   shape_concrete = HemisphericalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.005)\
...
def test_cad(_print_output: bool = False):
   ...
   shape_concrete = HemisphericalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.005)
   shape_concrete_rolled = HemisphericalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.005)\
                                                                    .set_orientation(roll_deg=20.0, pitch_deg=0.0, yaw_deg=0.0)
   shape_concrete_pitched = HemisphericalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.005)\
                                                                     .set_orientation(roll_deg=0.0, pitch_deg=20.0, yaw_deg=0.0)
   shape_concrete_yawed = HemisphericalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.005)\
                                                                   .set_orientation(roll_deg=0.0, pitch_deg=0.0, yaw_deg=20.0)
   shape_concrete_rotated = HemisphericalCapsule(concrete_identifier).set_geometry(cylinder_radius_m=0.1, cylinder_length_m=0.3, cylinder_thickness_m=0.01, endcap_thickness_m=0.005)\
