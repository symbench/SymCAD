...
from symcad.parts import Torisphere, SymPart

symbolic_identifier = 'torisphere_symbolic'
hybrid_identifier = 'torisphere_hybrid'
concrete_identifier = 'torisphere_concrete'

def test_construction(print_output: bool = False):

   # Construct a default instance of the shape
   shape_symbolic = Torisphere(symbolic_identifier)

   # Assert that the shape type is as expected
   assert issubclass(Torisphere, SymPart)
   assert isinstance(shape_symbolic, SymPart)
   assert isinstance(shape_symbolic, Torisphere)
   ...
   assert shape_symbolic.geometry.base_radius == sympy.Symbol(symbolic_identifier + '_base_radius')
...
def test_setting(print_output: bool = False):
   ...
   shape_symbolic = Torisphere(symbolic_identifier)
   shape_hybrid = Torisphere(hybrid_identifier).set_geometry(base_radius_m=None, crown_ratio_percent=1.0, knuckle_ratio_percent=0.06, thickness_m=None)
   shape_concrete = Torisphere(concrete_identifier).set_geometry(base_radius_m=0.3, crown_ratio_percent=1.0, knuckle_ratio_percent=0.06, thickness_m=0.01)\
   ...
   shape_symbolic.set_geometry(base_radius_m=None, crown_ratio_percent=None, knuckle_ratio_percent=None, thickness_m=None)
   shape_hybrid.set_geometry(base_radius_m=None, crown_ratio_percent=1.0, knuckle_ratio_percent=0.06, thickness_m=None)
   shape_concrete.set_geometry(base_radius_m=0.3, crown_ratio_percent=1.0, knuckle_ratio_percent=0.06, thickness_m=0.01)
   ...
   assert shape_hybrid.geometry.base_radius == sympy.Symbol(hybrid_identifier + '_base_radius')
   assert shape_hybrid.geometry.crown_ratio == 1.0
   assert shape_hybrid.geometry.knuckle_ratio == 0.06
   assert shape_hybrid.geometry.thickness == sympy.Symbol(hybrid_identifier + '_thickness')
   ...
   assert shape_concrete.geometry.base_radius == 0.3
...
def test_built_ins(print_output: bool = False):
   ...
   assert shape_symbolic.geometry.base_radius == 4.0 * sympy.Symbol(symbolic_identifier + '_base_radius')
   assert shape_symbolic.geometry.crown_ratio == sympy.Symbol(symbolic_identifier + '_crown_ratio')
   assert shape_symbolic.geometry.knuckle_ratio == sympy.Symbol(symbolic_identifier + '_knuckle_ratio')
   ...
   # Assert that all hybrid shape parameters are as expected
   assert shape_hybrid.geometry.base_radius == 4.0 * sympy.Symbol(hybrid_identifier + '_base_radius')
   assert shape_hybrid.geometry.crown_ratio == 1.0
   assert shape_hybrid.geometry.knuckle_ratio == 0.06
   assert shape_hybrid.geometry.thickness == 4.0 * sympy.Symbol(hybrid_identifier + '_thickness')
   assert shape_hybrid.orientation.roll == 0.0
   assert shape_hybrid.orientation.pitch == 0.0
   assert shape_hybrid.orientation.yaw == 0.0

   # Assert that all concrete shape parameters are as expected
   assert shape_concrete.geometry.base_radius == 1.2
   assert shape_concrete.geometry.crown_ratio == 1.0
   assert shape_concrete.geometry.knuckle_ratio == 0.06
   ...
   # Assert that the new shape dimensions are as expected
   assert shape_symbolic.geometry.base_radius == sympy.Symbol(symbolic_identifier + '_base_radius') / 4.0
   assert shape_symbolic.geometry.crown_ratio == sympy.Symbol(symbolic_identifier + '_crown_ratio')
   assert shape_symbolic.geometry.knuckle_ratio == sympy.Symbol(symbolic_identifier + '_knuckle_ratio')
   ...
   # Assert that all hybrid shape parameters are as expected
   assert shape_hybrid.geometry.base_radius == sympy.Symbol(hybrid_identifier + '_base_radius') / 4.0
   assert shape_hybrid.geometry.crown_ratio == 1.0
   assert shape_hybrid.geometry.knuckle_ratio == 0.06
   assert shape_hybrid.geometry.thickness == sympy.Symbol(hybrid_identifier + '_thickness') / 4.0
   assert shape_hybrid.orientation.roll == 0.0
   assert shape_hybrid.orientation.pitch == 0.0
   assert shape_hybrid.orientation.yaw == 0.0

   # Assert that all concrete shape parameters are as expected
   assert shape_concrete.geometry.base_radius == 0.3 / 4.0
   assert shape_concrete.geometry.crown_ratio == 1.0
   assert shape_concrete.geometry.knuckle_ratio == 0.06
...
def test_geometric_properties(print_output: bool = False):
   ...
   # Construct various versions of the shape
   shape_symbolic = Torisphere(symbolic_identifier)
   shape_hybrid = Torisphere(hybrid_identifier).set_geometry(base_radius_m=None, crown_ratio_percent=1.0, knuckle_ratio_percent=0.10, thickness_m=None)
   shape_concrete = Torisphere(concrete_identifier).set_geometry(base_radius_m=0.6, crown_ratio_percent=1.0, knuckle_ratio_percent=0.10, thickness_m=0.01)
...
def test_cad(_print_output: bool = False):
   ...
   shape_concrete = Torisphere(concrete_identifier).set_geometry(base_radius_m=0.6, crown_ratio_percent=1.0, knuckle_ratio_percent=0.12, thickness_m=0.01)
   shape_concrete_rolled = Torisphere(concrete_identifier).set_geometry(base_radius_m=0.6, crown_ratio_percent=1.0, knuckle_ratio_percent=0.12, thickness_m=0.01)\
                                                          .set_orientation(roll_deg=20.0, pitch_deg=0.0, yaw_deg=0.0)
   shape_concrete_pitched = Torisphere(concrete_identifier).set_geometry(base_radius_m=0.6, crown_ratio_percent=1.0, knuckle_ratio_percent=0.12, thickness_m=0.01)\
                                                           .set_orientation(roll_deg=0.0, pitch_deg=20.0, yaw_deg=0.0)
   shape_concrete_yawed = Torisphere(concrete_identifier).set_geometry(base_radius_m=0.6, crown_ratio_percent=1.0, knuckle_ratio_percent=0.12, thickness_m=0.01)\
                                                         .set_orientation(roll_deg=0.0, pitch_deg=0.0, yaw_deg=20.0)
   shape_concrete_rotated = Torisphere(concrete_identifier).set_geometry(base_radius_m=0.6, crown_ratio_percent=1.0, knuckle_ratio_percent=0.12, thickness_m=0.01)\
                                                           .set_orientation(roll_deg=-20.0, pitch_deg=-20.0, yaw_deg=-20.0)

   # Export FreeCAD versions of the rotated shapes
   shape_concrete.export('torisphere.FCStd', 'freecad')
   shape_concrete_rolled.export('torisphere_rolled.FCStd', 'freecad')
   shape_concrete_pitched.export('torisphere_pitched.FCStd', 'freecad')
   shape_concrete_yawed.export('torisphere_yawed.FCStd', 'freecad')
   shape_concrete_rotated.export('torisphere_rotated.FCStd', 'freecad')
   os.remove('torisphere.FCStd')
   os.remove('torisphere_rolled.FCStd')
   os.remove('torisphere_pitched.FCStd')
   os.remove('torisphere_yawed.FCStd')
   os.remove('torisphere_rotated.FCStd')
