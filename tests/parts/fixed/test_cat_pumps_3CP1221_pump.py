...
import os
from symcad.parts import SymPart, CatPumps3CP1221Pump
...
def test_construction(print_output: bool = False):
   ...
   shape = CatPumps3CP1221Pump(shape_identifier)

   # Assert that the shape type is as expected
   assert issubclass(CatPumps3CP1221Pump, SymPart)
   assert isinstance(shape, SymPart)
   assert isinstance(shape, CatPumps3CP1221Pump)
...
def test_cad(_print_output: bool = False):
   ...
   shape = CatPumps3CP1221Pump(shape_identifier)
   shape_rolled = CatPumps3CP1221Pump(shape_identifier)\
      .set_orientation(roll_deg=20.0, pitch_deg=0.0, yaw_deg=0.0)
   shape_pitched = CatPumps3CP1221Pump(shape_identifier)\
      .set_orientation(roll_deg=0.0, pitch_deg=20.0, yaw_deg=0.0)
   shape_yawed = CatPumps3CP1221Pump(shape_identifier)\
      .set_orientation(roll_deg=0.0, pitch_deg=0.0, yaw_deg=20.0)
   shape_rotated = CatPumps3CP1221Pump(shape_identifier)\
