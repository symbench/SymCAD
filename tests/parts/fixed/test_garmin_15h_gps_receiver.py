...
import os
from symcad.parts import SymPart, Garmin15HGpsReceiver
...
def test_construction(print_output: bool = False):
   ...
   shape = Garmin15HGpsReceiver(shape_identifier)

   # Assert that the shape type is as expected
   assert issubclass(Garmin15HGpsReceiver, SymPart)
   assert isinstance(shape, SymPart)
   assert isinstance(shape, Garmin15HGpsReceiver)
...
def test_cad(_print_output: bool = False):
   ...
   shape = Garmin15HGpsReceiver(shape_identifier)
   shape_rolled = Garmin15HGpsReceiver(shape_identifier)\
      .set_orientation(roll_deg=20.0, pitch_deg=0.0, yaw_deg=0.0)
   shape_pitched = Garmin15HGpsReceiver(shape_identifier)\
      .set_orientation(roll_deg=0.0, pitch_deg=20.0, yaw_deg=0.0)
   shape_yawed = Garmin15HGpsReceiver(shape_identifier)\
      .set_orientation(roll_deg=0.0, pitch_deg=0.0, yaw_deg=20.0)
   shape_rotated = Garmin15HGpsReceiver(shape_identifier)\
