...
from symcad.parts import CylinderWithConicalEnds, SymPart

symbolic_identifier = 'fairing_symbolic'
hybrid_identifier = 'fairing_hybrid'
concrete_identifier = 'fairing_concrete'

def test_construction(print_output: bool = False):

   # Construct a default instance of the shape
   shape_symbolic = CylinderWithConicalEnds(symbolic_identifier)

   # Assert that the shape type is as expected
   assert issubclass(CylinderWithConicalEnds, SymPart)
   assert isinstance(shape_symbolic, SymPart)
   assert isinstance(shape_symbolic, CylinderWithConicalEnds)
   ...
   assert shape_symbolic.geometry.nose_tip_radius == sympy.Symbol(symbolic_identifier + '_nose_tip_radius')
   assert shape_symbolic.geometry.nose_length == sympy.Symbol(symbolic_identifier + '_nose_length')
   assert shape_symbolic.geometry.body_radius == sympy.Symbol(symbolic_identifier + '_body_radius')
   assert shape_symbolic.geometry.body_length == sympy.Symbol(symbolic_identifier + '_body_length')
   assert shape_symbolic.geometry.tail_tip_radius == sympy.Symbol(symbolic_identifier + '_tail_tip_radius')
   assert shape_symbolic.geometry.tail_length == sympy.Symbol(symbolic_identifier + '_tail_length')
...
def test_setting(print_output: bool = False):
   ...
   shape_symbolic = CylinderWithConicalEnds(symbolic_identifier)
   shape_hybrid = CylinderWithConicalEnds(hybrid_identifier).set_geometry(nose_tip_radius_m=0.02, nose_length_m=None, body_radius_m=0.6, body_length_m=None, tail_tip_radius_m=0.1, tail_length_m=None, thickness_m=0.01)
   shape_concrete = CylinderWithConicalEnds(concrete_identifier).set_geometry(nose_tip_radius_m=0.02, nose_length_m=0.3, body_radius_m=0.6, body_length_m=1.5, tail_tip_radius_m=0.1, tail_length_m=0.8, thickness_m=0.01)\
   ...
   assert shape_hybrid.geometry.nose_tip_radius == 0.02
   assert shape_hybrid.geometry.nose_length == sympy.Symbol(hybrid_identifier + '_nose_length')
   assert shape_hybrid.geometry.body_radius == 0.6
   assert shape_hybrid.geometry.body_length == sympy.Symbol(hybrid_identifier + '_body_length')
   assert shape_hybrid.geometry.tail_tip_radius == 0.1
   assert shape_hybrid.geometry.tail_length == sympy.Symbol(hybrid_identifier + '_tail_length')
   ...
   assert shape_concrete.geometry.nose_tip_radius == 0.02
   assert shape_concrete.geometry.nose_length == 0.3
   assert shape_concrete.geometry.body_radius == 0.6
   assert shape_concrete.geometry.body_length == 1.5
   assert shape_concrete.geometry.tail_tip_radius == 0.1
   assert shape_concrete.geometry.tail_length == 0.8
...
def test_geometric_properties(print_output: bool = False):
   ...
   shape_symbolic = CylinderWithConicalEnds(symbolic_identifier)
   shape_hybrid = CylinderWithConicalEnds(hybrid_identifier).set_geometry(nose_tip_radius_m=0.02, nose_length_m=None, body_radius_m=0.6, body_length_m=None, tail_tip_radius_m=0.1, tail_length_m=None, thickness_m=0.01)
   shape_concrete = CylinderWithConicalEnds(concrete_identifier, 2.0).set_geometry(nose_tip_radius_m=0.02, nose_length_m=0.3, body_radius_m=0.6, body_length_m=1.5, tail_tip_radius_m=0.1, tail_length_m=0.8, thickness_m=0.01)

   # Assert that all concrete geometric properties are as expected
   cad_props = shape_concrete.get_cad_physical_properties()
   print(cad_props)
   print(shape_concrete.surface_area)
...
def test_oriented_properties(print_output: bool = False):
   ...
   shape_concrete = CylinderWithConicalEnds(concrete_identifier, 2.0).set_geometry(nose_tip_radius_m=0.02, nose_length_m=0.3, body_radius_m=0.6, body_length_m=1.5, tail_tip_radius_m=0.1, tail_length_m=0.8, thickness_m=0.01)\
                                                                     ...
                                                                     .set_placement(placement=(0.0, 0.0, 0.0), local_origin=(0.5, 0.5, 0.0))
...
def test_cad(_print_output: bool = False):
   ...
   shape_concrete = CylinderWithConicalEnds(concrete_identifier).set_geometry(nose_tip_radius_m=0.02, nose_length_m=0.3, body_radius_m=0.6, body_length_m=1.5, tail_tip_radius_m=0.1, tail_length_m=0.8, thickness_m=0.01)
   shape_concrete_rolled = CylinderWithConicalEnds(concrete_identifier).set_geometry(nose_tip_radius_m=0.02, nose_length_m=0.3, body_radius_m=0.6, body_length_m=1.5, tail_tip_radius_m=0.1, tail_length_m=0.8, thickness_m=0.01)\
                                                                       .set_orientation(roll_deg=20.0, pitch_deg=0.0, yaw_deg=0.0)
   shape_concrete_pitched = CylinderWithConicalEnds(concrete_identifier).set_geometry(nose_tip_radius_m=0.02, nose_length_m=0.3, body_radius_m=0.6, body_length_m=1.5, tail_tip_radius_m=0.1, tail_length_m=0.8, thickness_m=0.01)\
                                                                        .set_orientation(roll_deg=0.0, pitch_deg=20.0, yaw_deg=0.0)
   shape_concrete_yawed = CylinderWithConicalEnds(concrete_identifier).set_geometry(nose_tip_radius_m=0.02, nose_length_m=0.3, body_radius_m=0.6, body_length_m=1.5, tail_tip_radius_m=0.1, tail_length_m=0.8, thickness_m=0.01)\
                                                                      .set_orientation(roll_deg=0.0, pitch_deg=0.0, yaw_deg=20.0)
   shape_concrete_rotated = CylinderWithConicalEnds(concrete_identifier).set_geometry(nose_tip_radius_m=0.02, nose_length_m=0.3, body_radius_m=0.6, body_length_m=1.5, tail_tip_radius_m=0.1, tail_length_m=0.8, thickness_m=0.01)\
                                                                        .set_orientation(roll_deg=-20.0, pitch_deg=-20.0, yaw_deg=-20.0)

   # Export FreeCAD versions of the rotated shapes
   shape_concrete.export('fairing.FCStd', 'freecad')
   shape_concrete_rolled.export('fairing_rolled.FCStd', 'freecad')
   shape_concrete_pitched.export('fairing_pitched.FCStd', 'freecad')
   shape_concrete_yawed.export('fairing_yawed.FCStd', 'freecad')
   shape_concrete_rotated.export('fairing_rotated.FCStd', 'freecad')
   os.remove('fairing.FCStd')
   os.remove('fairing_rolled.FCStd')
   os.remove('fairing_pitched.FCStd')
   os.remove('fairing_yawed.FCStd')
   os.remove('fairing_rotated.FCStd')
